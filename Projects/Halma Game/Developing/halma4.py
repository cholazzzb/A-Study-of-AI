...
from StatisticsClass import StatisticsData, MoveContainer
...
def halma4(p1, p2, p3, p4):
    ...
    while (valid==model.S_OK):
        ...
        moveContainer.updateMoveData((tujuan, asal, aksi))
        ...
        if valid == model.S_OK:
            layar.tampilGanti(model, moveContainer)
